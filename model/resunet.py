...
class ResUNetSP(ME.MinkowskiNetwork):
    ...
    def __init__(self,
        ...
        self.pool2 = ME.MinkowskiSumPooling(
        ...
        self.pool3 = ME.MinkowskiSumPooling(
            kernel_size=2, stride=2, dimension=D)
        self.conv3 = conv(
            in_channels=CHANNELS[2],
            out_channels=CHANNELS[3],
        ...
        self.pool3_tr = ME.MinkowskiPoolingTranspose(
            kernel_size=2, stride=2, dimension=D)
        ...
        self.pool2_tr = ME.MinkowskiPoolingTranspose(
            kernel_size=2, stride=2, dimension=D)
...
class ResUNet2SP(ME.MinkowskiNetwork):
    ...
    def __init__(self,
        ...
        self.pool4 = ME.MinkowskiSumPooling(
            kernel_size=2, stride=2, dimension=D)
        self.conv4 = conv(
            in_channels=CHANNELS[3],
            out_channels=CHANNELS[4],
