...
class SimpleNet(ME.MinkowskiNetwork):
    ...
    def __init__(self,
        ...
        self.conv1 = ME.MinkowskiConvolution(
            ...
            dimension=D)
        self.norm1 = get_norm(
            NORM_TYPE, CHANNELS[1], bn_momentum=bn_momentum, D=D)
        ...
        self.conv2 = ME.MinkowskiConvolution(
            ...
            dimension=D)
        self.norm2 = get_norm(
            NORM_TYPE, CHANNELS[2], bn_momentum=bn_momentum, D=D)
        ...
        self.conv3 = ME.MinkowskiConvolution(
            ...
            dimension=D)
        self.norm3 = get_norm(
            NORM_TYPE, CHANNELS[3], bn_momentum=bn_momentum, D=D)
        ...
        self.norm1_tr = get_norm(
            NORM_TYPE, TR_CHANNELS[1], bn_momentum=bn_momentum, D=D)
...
class SimpleNet2(ME.MinkowskiNetwork):
    ...
    def __init__(self,
        ...
        self.conv4 = ME.MinkowskiConvolution(
            ...
            dimension=D)
        self.norm4 = get_norm(
            NORM_TYPE, CHANNELS[4], bn_momentum=bn_momentum, dimension=D)
...
class SimpleNet3(ME.MinkowskiNetwork):
    ...
    def __init__(self,
        ...
        self.conv5 = ME.MinkowskiConvolution(
            ...
            dimension=D)
        self.norm5 = get_norm(
            NORM_TYPE, CHANNELS[5], bn_momentum=bn_momentum, dimension=D)
